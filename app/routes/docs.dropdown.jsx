...
${accountItems
          ...
          <article aria-label="Dropdowns inside nav" className="component">
            <nav>
              ...
              <ul>
                ...
                <li>
                  <button aria-controls="dropdown-button">Account</button>
                  <DropdownItems items={accountItems} dir="rtl" id="dropdown-button" />
                </li>
              </ul>
            </nav>
            <footer>
  ...
  <ul>
    ...
    <li>
      <button aria-controls="dropdown-button">
        Account
      </button>
          ...
          <article aria-label="Dropdowns inside nav" className="component">
            <nav>
              ...
              <ul>
                ...
                <li>
                  <Item aria-controls="dropdown-link">Account</Item>
                  <DropdownItems items={accountItems} dir="rtl" id="dropdown-link" />
                </li>
              </ul>
            </nav>
            <footer>
